...
If you need to call a function that takes no argument at `.p`, you can set `.x` as `NULL`, which is also the default. If ever you don't pass anything to `.x`, don't forget to name the arguments.

```{r}
true <- function() TRUE
false <- function() FALSE
stop_if(.p =  true, msg = "This is true")
