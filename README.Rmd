...
{attempt} is designed to handle the cases when something / someone attempts to do something it shouldn't. For example, if you attempt to run a `log(a)`, or attempt to connect to an web API without the internet.
